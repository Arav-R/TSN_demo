...
class FloatSpinbox(customtkinter.CTkFrame):
    ...
    def add_button_callback(self, event=None):
        ...
        try:
            ...
            if (self.motor == 1):
                asyncio.run(coap_client.single_put("coap://10.1.1.61/multistep/cmd", "1"))
            elif (self.motor == 2):
...
class App(customtkinter.CTk):
    ...
    def microstep_callback(self, value):
        ...
        global step
        if value == "Full Step":
            asyncio.run(coap_client.single_put("coap://10.1.1.61/microstep/cmd", "1"))
            ...
            asyncio.run(coap_client.single_put("coap://10.1.1.61/microstep/cmd", "2"))
            ...
            asyncio.run(coap_client.single_put("coap://10.1.1.61/microstep/cmd", "4"))
            ...
            asyncio.run(coap_client.single_put("coap://10.1.1.61/microstep/cmd", "8"))
    ...
    def zero_button_event(self, event=None):
        asyncio.run(coap_client.single_put("coap://10.1.1.61/total/cmd", "0")) # = 0
        ...
        step1 = asyncio.run(coap_client.single_put("coap://10.1.1.61/total/cmd", "-1"))
    ...
    def speed_slider_callback(self, value):
        ...
        asyncio.run(coap_client.single_put("coap://10.1.1.61/speed/cmd", str(int(value))))
    ...
    def accel_slider_callback(self, value):
        ...
        asyncio.run(coap_client.single_put("coap://10.1.1.61/accel/cmd", str(int(value))))
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if on:
            ...
            ret = asyncio.run(coap_client.single_get("coap://10.1.1.61/safe/cmd")) # = 0
            ...
            first = time.time()
            asyncio.run(coap_client.single_put("coap://10.1.1.61/multistep/cmd", str(25*int(step))))
            seconds = time.time()
            y = seconds - first
